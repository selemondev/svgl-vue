  ...
  >
    ...
    <g mask="url(#a)">
      <path
        fill="#000"
        fill-rule="evenodd"
        d="M-.5.5h38v128.222c18.536-11.478 42.665-17.28 71-17.28 27.241 0 42.879-6.582 51.947-15.807 9.128-9.287 15.053-24.756 15.053-50.158V.5h38v44.977c0 30.568-7.075 57.577-25.947 76.775-18.932 19.261-46.294 27.171-79.053 27.171-27.227 0-45.08 6.481-55.707 14.889C42.628 172.355 37.5 183.34 37.5 196.898V253.5h-38V.5Z"
        clip-rule="evenodd"
      />
      <mask
        id="b"
