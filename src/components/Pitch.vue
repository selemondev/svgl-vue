...
<template>
    <svg version="1.1" id="Layer_1" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 57.6 65" style="enable-background:new 0 0 57.6 65;" xml:space="preserve" :key="width" :width="width" :height="height" :style="{
 ...
 <metadata>
  <sfw xmlns="ns_sfw;">
   ...
   <sliceSourceBounds bottomLeftOrigin="true" height="65" width="57.6" x="-119.3" y="43.9">
   </sliceSourceBounds>
  </sfw>
 </metadata>
 <g>
