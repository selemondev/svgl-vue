...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" style="pointer-events:none;display:block;width:100%;height:100%" viewBox="0 0 24 24" :key="width" :width="width" :height="height" :style="{
