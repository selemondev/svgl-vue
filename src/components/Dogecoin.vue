...
<template>
  ...
  >
    ...
    <g fill="none" fill-rule="evenodd">
      <use fill="#000" filter="url(#doge-a)" xlink:href="#doge-b" />
      <use fill="#C3A634" xlink:href="#doge-b" />
      <use
        fill="url(#doge-c)"
      ...
      <g>
        <use fill="#000" filter="url(#doge-d)" xlink:href="#doge-e" />
        <use fill="#FFF" xlink:href="#doge-e" />
      </g>
    </g>
  </svg>
</template>
